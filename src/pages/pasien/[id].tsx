                        ...
                        <div className="justify-between gap-5 my-5 md:grid-cols-2">
                            ...
                            <div className="justify-between gap-5 my-5">
                                <SelectInput
                                    ...
                                    defaultValue={account?.id}  // Pre-fill the account field
                                >
                                    {accounts.length > 0 ? (
                                ...
                                <SelectInput
                                    ...
                                    value={profile?.id || "AAAA"}  // Ensure the profile field is empty after account change
                                >
                                    <option value="">Pilih Profile</option>  {/* Add placeholder option */}
